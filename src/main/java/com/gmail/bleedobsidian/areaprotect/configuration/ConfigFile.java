...
public class ConfigFile {
    ...
    /**
     * Create new Configuration File with given name.
     * 
     * @param name
     *            - Name of config file.
     */
    ...
    /**
     * Create new Configuration File with given name and name of default config.
     * 
     * @param name
     *            - Name of config file.
     * @param defaultName
     *            - Name of the default config to copy.
     */
