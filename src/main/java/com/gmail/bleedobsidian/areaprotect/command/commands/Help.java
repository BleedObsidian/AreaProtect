...
public class Help {
    public static void help(AreaProtect areaProtect, Player player,
            String[] args) {
        ...
        PlayerLogger.message(player,
                language.getMessage("Player.Help.Message11"));
        PlayerLogger.message(player,
                language.getMessage("Player.Help.Message12"));
        PlayerLogger.message(player,
                language.getMessage("Player.Help.Message13"));
        PlayerLogger.message(player,
                language.getMessage("Player.Help.Message14"));
        return;
    }
}
